...
<body class="m-page--fluid m--skin- m-content--skin-light2 m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default">
    ...
    <div class="m-grid m-grid--hor m-grid--root m-page">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="m-portlet m-portlet--tab">
                            ...
                            <!--begin::Form-->
                            <form action="{{ asset('channel/edit/'.$channel->channel_id) }}" method="post" class="m-form m-form--fit m-form--label-align-right" enctype="multipart/form-data">
                                ...
                                <div class="m-portlet__body">
                                    ...
                                    <div class="form-group m-form__group row">
                                        ...
                                        @foreach($streams as $key => $stream)
                                            <option rel="{{$stream->channel_url}}" {{($channel->channel_id == $stream->id) ? 'selected' : ''}} value="{{$stream->id}}">{{$stream->channel_name}}</option>
                                        @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-5">
                                            <input type="text" class="form-control m-input" placeholder="Enter Video Key" id="class_key" name="class_key" value="{{ $channel->class_key }}" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-5">
                                            <input type="text" class="form-control m-input" placeholder="Enter Channel Name" id="class_name" name="class_name" value="{{ $channel->class_name }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-5">
                                            <select id="status" name="status" class="form-control m-input">
                                                ...
                                                <option value="active" {{($channel->status == 'active') ? 'selected' : ''}} selected>Active</option>
		...
		$("#video_url").val($("#channel_id").children("option:selected").attr("rel"));

                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="m-portlet m-portlet--tab">
                            ...
                            <!--begin::Form-->
                            <form action="{{ asset('content/add') }}" method="post" class="m-form m-form--fit m-form--label-align-right" enctype="multipart/form-data">
                                ...
                                <div class="m-portlet__body">
                                    ...
                                    <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-5">
                                            <input type="text" class="form-control m-input" placeholder="Enter Content Name" id="content_id" name="content_id" value="{{Request::old('content_id')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-5">
                                            <textarea class="form-control m-input" placeholder="Enter Content Description" id="content_description" name="content_description">{{Request::old('content_description')}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-5">
                                            <input type="text" class="form-control m-input" placeholder="Enter Video Url" id="video_url" name="video_url" value="{{Request::old('video_url')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-5">
                                            <input type="text" class="form-control m-input" placeholder="Enter Video Key" id="video_key" name="video_key" value="{{Request::old('video_key')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-5">
                                            <select id="status" name="status" class="form-control m-input">
                                                ...
                                                <option value="active" {{(Request::old('status') == 'active') ? 'selected' : ''}}>Active</option>
                                    ...
                                    <div class="m-form__actions">
                                        <div class="row">
                                            ...
                                            <div class="col-10">
                                                ...
                                                <button type="button" class="btn btn-secondary" onclick="window.open('{{ asset('content') }}','_self')">
                                                    Cancel
                                                </button>
                                            </div>
                                        </div>

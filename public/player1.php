...
<html lang="en">
	...
	<body>
		...
		var manifestUri ='https://stepapp-encoded-content.s3.ap-south-1.amazonaws.com/5ec64d928a271791304a2c72/te-auto/mpd/stream.mpd';
		...
		function initPlayer(manifestUri) {
			  ...
			  shakaVideoPlayer.configure({
				  drm: {
					...
					clearKeys: {
						"047ce83ec4db8b58117557c4512426fe":"b3f991b6ae49c0bcef0b67063e76d41d"
		                           	}
				  }
				});
